...
subtitle: "v.`r SpaDES.core::moduleMetadata(module = 'fireSense_hindcast', path = '..')$version`"
...
```{r setup-fireSense-hindcast, include=FALSE}
...
`r paste(as.character(SpaDES.core::moduleMetadata(module = "fireSense_hindcast", path = '..')$authors), sep = ', ')`
...
```{r moduleInputs-fireSense-hindcast, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_inputs <- SpaDES.core::moduleInputs("fireSense_hindcast", "..")
knitr::kable(df_inputs,
             caption = "List of (ref:fireSense-hindcast) input objects and their description.") |>
...
```{r moduleParams-fireSense-hindcast, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_params <- SpaDES.core::moduleParams("fireSense_hindcast", "..")
knitr::kable(df_params, caption = "List of (ref:fireSense-hindcast) parameters and their description.") |>
  kableExtra::kable_styling(latex_options = "scale_down", full_width = TRUE)
```
...
```{r moduleOutputs-fireSense-hindcast, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_outputs <- SpaDES.core::moduleOutputs("fireSense_hindcast", "..")
knitr::kable(df_outputs, caption = "List of (ref:fireSense-hindcast) outputs and their description.") |>
  kableExtra::kable_styling(latex_options = "scale_down", full_width = TRUE)
```
